---
name: code-review
description: Comprehensive code review following jeytech standards. Use when reviewing pull requests, auditing code quality, or preparing code for production deployment.
allowed-tools:
  - Read
  - Grep
  - Glob
